...
// ملاحظة مهمة: Cloudflare Workers (crypto.subtle) تفرض حدًا أقصى لعدد تكرارات
// PBKDF2 يبلغ 100,000 تحديدًا — أي رقم أعلى يفشل بخطأ "iteration counts above
// 100000 are not supported". هذا قيد خاص بهذه المنصة وليس معيارًا عامًا،
// لذلك 100,000 هو الحد الأقصى الفعلي الذي يمكن استخدامه هنا (وهو لا يزال
// رقمًا آمنًا ومقبولًا لتجزئة كلمات المرور).
